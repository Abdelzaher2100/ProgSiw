			...
			<div class="row">
                <div class="col-12">
                    <div class="section-heading dark text-center">
                        <span></span>
                        <h4>I tuoi noleggi <h4>
                        <p>Qui potrai avere uno storico riguardante i veicoli da te noleggiati</p>
                    </div>
                </div>
            </div>
           </div>
		...
		<div class="container">
			<div class="row">
                <div class="col-12">
                    <div class="section-heading dark text-center">
                        <span></span>
                        <h4>Tutti i noleggi <h4>
                        <p>Qui potrai avere uno storico riguardante i veicoli noleggiati dai clienti</p>
                    </div>
                </div>
            </div>
           </div>
					...
					<table>
						<thead>
							<tr class="table100-head">
								<th class="column1">IdNoleggio</th>
								<th class="column2">IdPrenotazione</th>
								<th class="column3">Prezzo</th>
								<th class="column4">Data Inizio </th>
								<th class="column5">Data Fine </th>
								<th class="column6">Categoria</th>
								<c:if test="${admin}">
						...
						<tbody>
								<c:forEach items="${noleggi}" var="n">

									<tr>
										<td class="column1">${n.id}</td>
										<td class="column2">${n.prenotazione.idPrenotazione}</td>
										<td class="column3">${n.prenotazione.prezzo}0 Euro</td>
										<td class="column4">${n.prenotazione.dataInizioPrenotazione.getDate()}/${n.prenotazione.dataInizioPrenotazione.getMonth()+1}/${n.prenotazione.dataInizioPrenotazione.getYear()+1900}</td>
										<td class="column5">${n.prenotazione.dataFinePrenotazione.getDate()}/${n.prenotazione.dataFinePrenotazione.getMonth()+1}/${n.prenotazione.dataFinePrenotazione.getYear()+1900}</td>
										<td class="column6">${n.veicolo.categoria}</td>
										<c:if test="${admin}">
